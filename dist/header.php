...
<body>
    ...
    <div class="position-relative z-index-30">
        <!-- Navbar -->
        <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom mx-0 p-0 flex-column  border-0 w-100 z-index-30 shadow-lg">
            <div class="w-100 pb-lg-0 pt-lg-0 pt-4 pb-3">
                <div class="container-fluid d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <!-- Main Navigation-->
                    <div class="flex-shrink-0 collapse navbar-collapse navbar-collapse-light w-auto flex-grow-1" id="navbarNavDropdown">
                        ...
                        <ul class="navbar-nav py-lg-0 mx-auto">
                            <li class="ms-4 nav-item me-lg-4 position-static">
                                <a class="nav-link fw-bolder py-lg-4" href="index.php" role="button">
                                    Home
                                </a>
                                ...
                                <!-- / Menswear dropdown menu-->
                            <!-- </li> -->
                            <li class="nav-item me-lg-4  position-static">
                                <a class="nav-link fw-bolder py-lg-4" href="Category.php" role="button">
                                    Product
                                </a>
                            ...
                            <li class="nav-item me-lg-4">
                                <a class="nav-link fw-bolder py-lg-4" href="cart.php">
                                    Cart
                                </a>
                            </li>
                            <!-- <li class="nav-item  me-lg-4">
                                <a class="nav-link fw-bolder py-lg-4" href="checkout.php" role="button">
                                    Checkout
                                </a>
                            </li> -->
                            <li class="nav-item me-lg-4">
                                <a class="nav-link fw-bolder py-lg-4" href="contact.php">
                                    Contact Us
                                </a>
                            </li>
                        </ul>             
                    ...
                    <ul class="list-unstyled mb-0 d-flex align-items-center">
                        ...
                        <li class=" nav-item dropdown me-lg-4">
                                <a class="nav-link fw-bolder dropdown py-lg-4" href="#" role="button" data-bs-toggle="dropdown"
                                    ...
                                    <?php
                                        if(isset($_SESSION['name'])=="admin"){
                                            if($_SESSION['name']=='admin'){
                                                echo '<li><a class="dropdown-item" href="../admin/index.php">Dashboard</a></li>';
                                            }
                                        }
                                    ?>
                                    <?php
