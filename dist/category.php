            ...
            <div class="container position-relative z-index-20" data-aos="fade-right" data-aos-delay="300">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active breadcrumb-light" aria-current="page">Product</li>
                    </ol>
                </nav>                
                    ...
                    <?php
                            ...
                            $con=new mysqli("localhost", "root", "", "library");
                                ...
                                while ($row=$rs->fetch_assoc())
                                {
                                    ...
                                    <div class='w-100 card ms-me-2 mt-3 mb-5 shadow-lg rounded-3'>
                                            ...
                                            <a style='text-decoration:none; background: #fa6129;' href='product.php?id=".$row['id']."' class='btn text-center text-white tw-bold rounded-bottom'>Buy Now</a>
                                    </div>
                                </div>  
                                    ";
                                }
